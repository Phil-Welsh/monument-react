...
function Blog() {
  return (
      <div>
        ...
        <nav>
            <a class="hamburger" href="toggle"><i class="fa fa-bars"></i></a>
            <ul>
        ...
        <div class="wrap grid-wrapper">
            ...
            <aside>
                ...
                <h3>Recent Issues</h3>
                <ul>
                    <li><a href="issue_nineteen">Issue Nineteen &mdash; Camping</a></li>
                    <li><a href="issue_eighteen">Issue Eighteen &mdash; Food</a></li>
                    <li><a href="issue_seventeen">Issue Seventeen &mdash; Signs</a></li>
                    <li><a href="issue_sixteen">Issue Sixteen &mdash; Friends</a></li>
                    <li><a href="issue_fifteen">Issue Fifteen &mdash; Carnivals</a></li>
                    <li><a href="issue_fourteen">Issue Fourteen &mdash; Gatherings</a></li>
                </ul>
            </aside>
